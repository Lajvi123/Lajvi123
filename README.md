...
**Data Scientist Intern – Edulyt**  
• Cleaned and transformed 500K+ banking transaction records using Python and SQL.  
• Built automated pipelines to improve data readiness and reporting speed.  
• Generated KPI dashboards and insights that supported business strategy.  

**Full Stack Engineer Intern – Larsen & Toubro**  
• Designed SQL databases and dashboards to improve operational data accessibility.  
